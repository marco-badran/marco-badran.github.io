...
\noindent
\begin{itemize}
	\item \emph{Nonlocal free boundary minimal surfaces.} (with S. Dipierro and E. Valdinoci) {\bf arXiv}
	\item \emph{Stationary $p$-harmonic maps approaching planar singular harmonic maps to the circle.} (with J. Van Schaftingen). {\bf Calc.\ Var.\ PDE.}
	\item \emph{Harmonic maps to the circle with higher dimensional singular set.} To appear in {\bf Proc.\ London Math.\ Soc.}
...
\noindent
\begin{itemize}
	\item Co-lecturer of \emph{Geometric Heat Flows}, D-MATH (Fall 25)
...
\textbf{Supervision:} 
\begin{itemize}
\item Andr\'e Dabrowski (Master Thesis, joint with J. Serra, ETH Zürich, 2025)
\item Martin Gonzalez Yu (Semester paper -- ETH Z\"urich, 2025)
	\item Derk Steffens (Master Thesis, joint with J. Serra, ETH Zürich, 2025)
